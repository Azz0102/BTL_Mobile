...
const Tabs = ({navigation}) => {
  ...
  //       accept?.forEach(item => {
  //         if (item.owner_info.admission_no === user.email.split('@')[0]) {
  //           setdata(item);
  //           accepted = true;
  //         }
  //       });
  ...
  return (
    <>
      {!isAccepted && (
        <Tab.Navigator initialRouteName="HomenDetails">
          ...
          <Tab.Screen
            ...
            options={{
              header: ({navigation}) => (
                <Header navigation={navigation} share={false} title="Cart" />
              ),
          ...
          <Tab.Screen
            ...
            options={{
              ...
              header: ({navigation}) => (
                <Header navigation={navigation} share={false} title="" />
              ),
              headerShadowVisible: false,
              tabBarStyle: {
                position: 'absolute',
      ...
      {isAccepted && (
        <Modal animationType="slide" transparent={true} visible={isAccepted}>
          <View
            style={{
              shadowColor: '#000000',
              shadowOffset: {
            ...
            <View className="items-center justify-center w-80 p-5 bg-green-500 rounded-3xl">
              ...
              <Text className="text-center pt-3 px-2 pb-5 my-2 text-gray-100">
                Your Order Delivery Contract is Accepted. Pay to Enjoy Your
                Delicious Food !
              </Text>
              {/* <Pressable
                onPress={() => {
                ...
                <Text className="text-center text-white font-bold">Pay</Text>
